...
function MyPet({ name, id, photo }: MyPetProps) {
  return (
    <div className="bg-white flex gap-8 p-5 rounded-sm">
      <div className="size-[150px] rounded-sm overflow-clip">
      ...
      <div className="flex flex-col gap-2">
        ...
        <Link 
        to={`/pet/${id}`} 
        className="font-semibold text-lg text-brown hover:underline underline-offset-4 mb-2 self-start"
        >
          Ver perfil do pet
        </Link>
